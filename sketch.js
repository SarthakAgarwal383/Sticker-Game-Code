...
text("Score:"+score,50,50);
 ...
 /*if(istouching(gem,player)){
score=score+1;
  reset()
 }*/
 
 if(Matter.SAT.collides(gem,player).collided){
   score=score+1;
   reset();
 }
...
function istouching(o1,o2){
  if(o1.body.position.x-o2.body.position.x<o1.body.width/2+o2.body.width/2 &&
    o2.body.position.x-o1.body.position.x<o1.body.width/2+o2.body.width/2 &&
    o2.body.position.y-o1.body.position.y<o1.body.height/2+o2.body.height/2 &&
    o1.body.position.y-o2.body.position.y<o1.body.height/2+o2.body.height/2){
      return true;
